					...
					<ul>
						...
						<li>
							...
							<div class="d-inline">
								...
								</select> <input type="text" class="d-inline form-control col-7">
							</div>
						</li>
					</ul>
			...
			<table class="table">
				<thead>
					<tr class="row bg-light">
						...
						<td class="col-2 text-center">주문상태</td>
				...
				<tbody>
					<tr class="row">
								...
								<div class="row no-gutters">
									...
									<div class="col-md-8">
										<div class="card-body p-1 ml-2">
											...
											<p class="card-title font-weight-bolder">[KONGES SLOJD]
												헨리넥 셔츠</p>
											<p class="card-text">
						...
						<td class="col-1 text-center align-middle">1</td>
						<td class="col-1 text-center align-middle">￦70,000</td>
						<td class="col-2 text-center align-middle">취소</td>
